  ...
  return [
    {
      ...
      description:
        'Configure build settings for Unity project including platform, scenes, and player settings.',
      inputSchema: {
        type: 'object',
        properties: {
          target: {
...

    {
      name: 'build.execute',
      description:
        'Execute a build with current settings or specified configuration.',
      inputSchema: {
        type: 'object',
        properties: {
          target: {
...

    {
      name: 'build.runTests',
      description:
        'Run Unity tests (EditMode and/or PlayMode) and return results.',
      inputSchema: {
        type: 'object',
        properties: {
          mode: {
...

    {
      ...
      description:
        'Get detailed information about the last build including size, warnings, and errors.',
      inputSchema: {
        type: 'object',
        properties: {
          includeAssets: {
...

    {
      name: 'build.optimize',
      description:
        'Analyze and optimize build settings for size and performance.',
      inputSchema: {
        type: 'object',
        properties: {
          target: {
...

    {
      ...
      description:
        'Retrieve console logs from Unity Editor including errors, warnings, and debug messages.',
      inputSchema: {
        type: 'object',
        properties: {
          logTypes: {
