...
> **⚠️ Requires Commercial License** — A paid license from Unity MCP is required to use this software. See [README.md](README.md#-%EF%B8%8F-license) and the LICENSE file. Contact support@unitymcp.com for licensing.
...
4. Paste: `https://github.com/isekream/Unity_MCP.git?path=/Unity` (access requires commercial license)
