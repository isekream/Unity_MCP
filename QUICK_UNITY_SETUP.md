...
> **⚠️ Commercial License Required** — Unity MCP is commercial software. You must have a paid license to use or install it. Contact support@unitymcp.com to acquire a license and access credentials.
...
- Paste this URL:
  ...
  (licensed customers only; use provided credentials if prompted)
  ```
- Click `Add`
