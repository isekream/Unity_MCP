  ...
  return [
    {
      name: 'assets.import',
      description:
        'Import assets into the Unity project from file paths or URLs.',
      inputSchema: {
        type: 'object',
        properties: {
          sourcePath: {
          ...
          importSettings: {
            ...
            properties: {
              textureType: {
                type: 'string',
                description: 'Texture import type',
              },
...

    {
      ...
      description:
        'Create a new material with specified properties and shader.',
      inputSchema: {
        type: 'object',
        properties: {
          name: {
          ...
          path: {
            type: 'string',
            description:
              'Path to save the material (relative to Assets folder)',
          },
          shader: {
            type: 'string',
      ...
      inputSchema: {
        ...
        properties: {
          ...
          gameObjectName: {
            type: 'string',
            description:
              'Name of GameObject to create prefab from (for create action)',
          },
          instantiatePosition: {
            type: 'object',
            properties: {
...

    {
      name: 'assets.search',
      description:
        'Search for assets in the project based on various criteria.',
      inputSchema: {
        type: 'object',
        properties: {
          query: {
...

    {
      ...
      description:
        'Manage Unity packages - install, update, or remove packages.',
      inputSchema: {
        type: 'object',
        properties: {
          action: {
